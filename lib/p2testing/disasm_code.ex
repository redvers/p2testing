...
#                                           EEEE 0000000 CZI DDDDDDDDD SSSSSSSSS        ROR     D,S/#       {WC/WZ/WCZ}
  def ror(all=%{addr: addr, con: con, instr: "ROR", vars: {c,z,i,d,s}, fullbin: <<fullbin::size(32)>>}), do: ExPrintf.sprintf("%04x %08x %-12s %-7s %s, %s", [addr,fullbin,disasm_c(<<con::size(4)>>),"ror",tohex(0,d),"#{imm?(i)}#{tohex(0,s)}"])

#                                           EEEE 0000001 CZI DDDDDDDDD SSSSSSSSS        ROL     D,S/#       {WC/WZ/WCZ}
  def rol(all=%{addr: addr, con: con, instr: "ROL", vars: {c,z,i,d,s}, fullbin: <<fullbin::size(32)>>}), do: ExPrintf.sprintf("%04x %08x %-12s %-7s %s, %s", [addr,fullbin,disasm_c(<<con::size(4)>>),"rol",tohex(0,d),"#{imm?(i)}#{tohex(0,s)}"])

#                                           EEEE 0000010 CZI DDDDDDDDD SSSSSSSSS        SHR     D,S/#       {WC/WZ/WCZ}
def shr(all=%{addr: addr, con: con, instr: "SHR", vars: {c,z,i,d,s}, fullbin: <<fullbin::size(32)>>}), do: ExPrintf.sprintf("%04x %08x %-12s %-7s %s, %s", [addr,fullbin,disasm_c(<<con::size(4)>>),"shr",tohex(0,d),"#{imm?(i)}#{tohex(0,s)}"])

#                                           EEEE 0000011 CZI DDDDDDDDD SSSSSSSSS        SHL     D,S/#       {WC/WZ/WCZ}
  def shl(all=%{addr: addr, con: con, instr: "SHL", vars: {c,z,i,d,s}, fullbin: <<fullbin::size(32)>>}), do: ExPrintf.sprintf("%04x %08x %-12s %-7s %s, %s", [addr,fullbin,disasm_c(<<con::size(4)>>),"shl",tohex(0,d),"#{imm?(i)}#{tohex(0,s)}"])

#                                           EEEE 0000100 CZI DDDDDDDDD SSSSSSSSS        RCR     D,S/#       {WC/WZ/WCZ}
  def rcr(all=%{addr: addr, con: con, instr: "RCR", vars: {c,z,i,d,s}, fullbin: <<fullbin::size(32)>>}), do: ExPrintf.sprintf("%04x %08x %-12s %-7s %s, %s", [addr,fullbin,disasm_c(<<con::size(4)>>),"rcr",tohex(0,d),"#{imm?(i)}#{tohex(0,s)}"])

#                                           EEEE 0000101 CZI DDDDDDDDD SSSSSSSSS        RCL     D,S/#       {WC/WZ/WCZ}
  def rcl(all=%{addr: addr, con: con, instr: "RCL", vars: {c,z,i,d,s}, fullbin: <<fullbin::size(32)>>}), do: ExPrintf.sprintf("%04x %08x %-12s %-7s %s, %s", [addr,fullbin,disasm_c(<<con::size(4)>>),"rcl",tohex(0,d),"#{imm?(i)}#{tohex(0,s)}"])

#                                           EEEE 0000110 CZI DDDDDDDDD SSSSSSSSS        SAR     D,S/#       {WC/WZ/WCZ}
  def sar(all=%{addr: addr, con: con, instr: "SAR", vars: {c,z,i,d,s}, fullbin: <<fullbin::size(32)>>}), do: ExPrintf.sprintf("%04x %08x %-12s %-7s %s, %s", [addr,fullbin,disasm_c(<<con::size(4)>>),"sar",tohex(0,d),"#{imm?(i)}#{tohex(0,s)}"])

#                                           EEEE 0000111 CZI DDDDDDDDD SSSSSSSSS        SAL     D,S/#       {WC/WZ/WCZ}
  def sal(all=%{addr: addr, con: con, instr: "SAL", vars: {c,z,i,d,s}, fullbin: <<fullbin::size(32)>>}), do: ExPrintf.sprintf("%04x %08x %-12s %-7s %s, %s", [addr,fullbin,disasm_c(<<con::size(4)>>),"sal",tohex(0,d),"#{imm?(i)}#{tohex(0,s)}"])

#                                           EEEE 0001000 CZI DDDDDDDDD SSSSSSSSS        ADD     D,S/#       {WC/WZ/WCZ}
  def add(all=%{addr: addr, con: con, instr: "ADD", vars: {c,z,i,d,s}, fullbin: <<fullbin::size(32)>>}), do: ExPrintf.sprintf("%04x %08x %-12s %-7s %s, %s", [addr,fullbin,disasm_c(<<con::size(4)>>),"add",tohex(0,d),"#{imm?(i)}#{tohex(0,s)}"])

#                                           EEEE 0001001 CZI DDDDDDDDD SSSSSSSSS        ADDX    D,S/#       {WC/WZ/WCZ}
  def addx(all=%{addr: addr, con: con, instr: "ADDX", vars: {c,z,i,d,s}, fullbin: <<fullbin::size(32)>>}), do: ExPrintf.sprintf("%04x %08x %-12s %-7s %s, %s", [addr,fullbin,disasm_c(<<con::size(4)>>),"addx",tohex(0,d),"#{imm?(i)}#{tohex(0,s)}"])

#                                           EEEE 0001010 CZI DDDDDDDDD SSSSSSSSS        ADDS    D,S/#       {WC/WZ/WCZ}
  def adds(all=%{addr: addr, con: con, instr: "ADDS", vars: {c,z,i,d,s}, fullbin: <<fullbin::size(32)>>}), do: ExPrintf.sprintf("%04x %08x %-12s %-7s %s, %s", [addr,fullbin,disasm_c(<<con::size(4)>>),"adds",tohex(0,d),"#{imm?(i)}#{tohex(0,s)}"])

#                                           EEEE 0001011 CZI DDDDDDDDD SSSSSSSSS        ADDSX   D,S/#       {WC/WZ/WCZ}
  def addsx(all=%{addr: addr, con: con, instr: "ADDSX", vars: {c,z,i,d,s}, fullbin: <<fullbin::size(32)>>}), do: ExPrintf.sprintf("%04x %08x %-12s %-7s %s, %s", [addr,fullbin,disasm_c(<<con::size(4)>>),"addsx",tohex(0,d),"#{imm?(i)}#{tohex(0,s)}"])

#                                           EEEE 0001100 CZI DDDDDDDDD SSSSSSSSS        SUB     D,S/#       {WC/WZ/WCZ}
  def sub(all=%{addr: addr, con: con, instr: "SUB", vars: {c,z,i,d,s}, fullbin: <<fullbin::size(32)>>}), do: ExPrintf.sprintf("%04x %08x %-12s %-7s %s, %s", [addr,fullbin,disasm_c(<<con::size(4)>>),"sub",tohex(0,d),"#{imm?(i)}#{tohex(0,s)}"])

#                                           EEEE 0001101 CZI DDDDDDDDD SSSSSSSSS        SUBX    D,S/#       {WC/WZ/WCZ}
  def subx(all=%{addr: addr, con: con, instr: "SUBX", vars: {c,z,i,d,s}, fullbin: <<fullbin::size(32)>>}), do: ExPrintf.sprintf("%04x %08x %-12s %-7s %s, %s", [addr,fullbin,disasm_c(<<con::size(4)>>),"subx",tohex(0,d),"#{imm?(i)}#{tohex(0,s)}"])

#                                           EEEE 0001110 CZI DDDDDDDDD SSSSSSSSS        SUBS    D,S/#       {WC/WZ/WCZ}
  def subs(all=%{addr: addr, con: con, instr: "SUBS", vars: {c,z,i,d,s}, fullbin: <<fullbin::size(32)>>}), do: ExPrintf.sprintf("%04x %08x %-12s %-7s %s, %s", [addr,fullbin,disasm_c(<<con::size(4)>>),"subs",tohex(0,d),"#{imm?(i)}#{tohex(0,s)}"])

#                                           EEEE 0001111 CZI DDDDDDDDD SSSSSSSSS        SUBSX   D,S/#       {WC/WZ/WCZ}
  def subsx(all=%{addr: addr, con: con, instr: "SUBSX", vars: {c,z,i,d,s}, fullbin: <<fullbin::size(32)>>}), do: ExPrintf.sprintf("%04x %08x %-12s %-7s %s, %s", [addr,fullbin,disasm_c(<<con::size(4)>>),"subsx",tohex(0,d),"#{imm?(i)}#{tohex(0,s)}"])

#                                           EEEE 0010000 CZI DDDDDDDDD SSSSSSSSS        CMP     D,S/#       {WC/WZ/WCZ}
  def cmp(all=%{addr: addr, con: con, instr: "CMP", vars: {c,z,i,d,s}, fullbin: <<fullbin::size(32)>>}), do: ExPrintf.sprintf("%04x %08x %-12s %-7s %s, %s", [addr,fullbin,disasm_c(<<con::size(4)>>),"cmp",tohex(0,d),"#{imm?(i)}#{tohex(0,s)}"])

#                                           EEEE 0010001 CZI DDDDDDDDD SSSSSSSSS        CMPX    D,S/#       {WC/WZ/WCZ}
  def cmpx(all=%{addr: addr, con: con, instr: "CMPX", vars: {c,z,i,d,s}, fullbin: <<fullbin::size(32)>>}), do: ExPrintf.sprintf("%04x %08x %-12s %-7s %s, %s", [addr,fullbin,disasm_c(<<con::size(4)>>),"cmpx",tohex(0,d),"#{imm?(i)}#{tohex(0,s)}"])

#                                           EEEE 0010010 CZI DDDDDDDDD SSSSSSSSS        CMPS    D,S/#       {WC/WZ/WCZ}
  def cmps(all=%{addr: addr, con: con, instr: "CMPS", vars: {c,z,i,d,s}, fullbin: <<fullbin::size(32)>>}), do: ExPrintf.sprintf("%04x %08x %-12s %-7s %s, %s", [addr,fullbin,disasm_c(<<con::size(4)>>),"cmps",tohex(0,d),"#{imm?(i)}#{tohex(0,s)}"])

#                                           EEEE 0010011 CZI DDDDDDDDD SSSSSSSSS        CMPSX   D,S/#       {WC/WZ/WCZ}
  def cmpsx(all=%{addr: addr, con: con, instr: "CMPSX", vars: {c,z,i,d,s}, fullbin: <<fullbin::size(32)>>}), do: ExPrintf.sprintf("%04x %08x %-12s %-7s %s, %s", [addr,fullbin,disasm_c(<<con::size(4)>>),"cmpsx",tohex(0,d),"#{imm?(i)}#{tohex(0,s)}"])

#                                           EEEE 0010100 CZI DDDDDDDDD SSSSSSSSS        CMPR    D,S/#       {WC/WZ/WCZ}
  def cmpr(all=%{addr: addr, con: con, instr: "CMPR", vars: {c,z,i,d,s}, fullbin: <<fullbin::size(32)>>}), do: ExPrintf.sprintf("%04x %08x %-12s %-7s %s, %s", [addr,fullbin,disasm_c(<<con::size(4)>>),"cmpr",tohex(0,d),"#{imm?(i)}#{tohex(0,s)}"])

#                                           EEEE 0010101 CZI DDDDDDDDD SSSSSSSSS        CMPM    D,S/#       {WC/WZ/WCZ}
  def cmpm(all=%{addr: addr, con: con, instr: "CMPM", vars: {c,z,i,d,s}, fullbin: <<fullbin::size(32)>>}), do: ExPrintf.sprintf("%04x %08x %-12s %-7s %s, %s", [addr,fullbin,disasm_c(<<con::size(4)>>),"cmpm",tohex(0,d),"#{imm?(i)}#{tohex(0,s)}"])

#                                           EEEE 0010110 CZI DDDDDDDDD SSSSSSSSS        SUBR    D,S/#       {WC/WZ/WCZ}
  def subr(all=%{addr: addr, con: con, instr: "SUBR", vars: {c,z,i,d,s}, fullbin: <<fullbin::size(32)>>}), do: ExPrintf.sprintf("%04x %08x %-12s %-7s %s, %s", [addr,fullbin,disasm_c(<<con::size(4)>>),"subr",tohex(0,d),"#{imm?(i)}#{tohex(0,s)}"])

#                                           EEEE 0010111 CZI DDDDDDDDD SSSSSSSSS        CMPSUB  D,S/#       {WC/WZ/WCZ}
  def cmpsub(all=%{addr: addr, con: con, instr: "CMPSUB", vars: {c,z,i,d,s}, fullbin: <<fullbin::size(32)>>}), do: ExPrintf.sprintf("%04x %08x %-12s %-7s %s, %s", [addr,fullbin,disasm_c(<<con::size(4)>>),"cmpsub",tohex(0,d),"#{imm?(i)}#{tohex(0,s)}"])

#                                           EEEE 0011000 CZI DDDDDDDDD SSSSSSSSS        FGE     D,S/#       {WC/WZ/WCZ}
  def fge(all=%{addr: addr, con: con, instr: "FGE", vars: {c,z,i,d,s}, fullbin: <<fullbin::size(32)>>}), do: ExPrintf.sprintf("%04x %08x %-12s %-7s %s, %s", [addr,fullbin,disasm_c(<<con::size(4)>>),"fge",tohex(0,d),"#{imm?(i)}#{tohex(0,s)}"])

#                                           EEEE 0011001 CZI DDDDDDDDD SSSSSSSSS        FLE     D,S/#       {WC/WZ/WCZ}
  def fle(all=%{addr: addr, con: con, instr: "FLE", vars: {c,z,i,d,s}, fullbin: <<fullbin::size(32)>>}), do: ExPrintf.sprintf("%04x %08x %-12s %-7s %s, %s", [addr,fullbin,disasm_c(<<con::size(4)>>),"fle",tohex(0,d),"#{imm?(i)}#{tohex(0,s)}"])

#                                           EEEE 0011010 CZI DDDDDDDDD SSSSSSSSS        FGES    D,S/#       {WC/WZ/WCZ}
  def fges(all=%{addr: addr, con: con, instr: "FGES", vars: {c,z,i,d,s}, fullbin: <<fullbin::size(32)>>}), do: ExPrintf.sprintf("%04x %08x %-12s %-7s %s, %s", [addr,fullbin,disasm_c(<<con::size(4)>>),"fges",tohex(0,d),"#{imm?(i)}#{tohex(0,s)}"])

#                                           EEEE 0011011 CZI DDDDDDDDD SSSSSSSSS        FLES    D,S/#       {WC/WZ/WCZ}
  def fles(all=%{addr: addr, con: con, instr: "FLES", vars: {c,z,i,d,s}, fullbin: <<fullbin::size(32)>>}), do: ExPrintf.sprintf("%04x %08x %-12s %-7s %s, %s", [addr,fullbin,disasm_c(<<con::size(4)>>),"fles",tohex(0,d),"#{imm?(i)}#{tohex(0,s)}"])

#                                           EEEE 0011100 CZI DDDDDDDDD SSSSSSSSS        SUMC    D,S/#       {WC/WZ/WCZ}
  def sumc(all=%{addr: addr, con: con, instr: "SUMC", vars: {c,z,i,d,s}, fullbin: <<fullbin::size(32)>>}), do: ExPrintf.sprintf("%04x %08x %-12s %-7s %s, %s", [addr,fullbin,disasm_c(<<con::size(4)>>),"sumc",tohex(0,d),"#{imm?(i)}#{tohex(0,s)}"])

#                                           EEEE 0011101 CZI DDDDDDDDD SSSSSSSSS        SUMNC   D,S/#       {WC/WZ/WCZ}
  def sumnc(all=%{addr: addr, con: con, instr: "SUMNC", vars: {c,z,i,d,s}, fullbin: <<fullbin::size(32)>>}), do: ExPrintf.sprintf("%04x %08x %-12s %-7s %s, %s", [addr,fullbin,disasm_c(<<con::size(4)>>),"sumnc",tohex(0,d),"#{imm?(i)}#{tohex(0,s)}"])

#                                           EEEE 0011110 CZI DDDDDDDDD SSSSSSSSS        SUMZ    D,S/#       {WC/WZ/WCZ}
  def sumz(all=%{addr: addr, con: con, instr: "SUMZ", vars: {c,z,i,d,s}, fullbin: <<fullbin::size(32)>>}), do: ExPrintf.sprintf("%04x %08x %-12s %-7s %s, %s", [addr,fullbin,disasm_c(<<con::size(4)>>),"sumz",tohex(0,d),"#{imm?(i)}#{tohex(0,s)}"])

#                                           EEEE 0011111 CZI DDDDDDDDD SSSSSSSSS        SUMNZ   D,S/#       {WC/WZ/WCZ}
  def sumnz(all=%{addr: addr, con: con, instr: "SUMNZ", vars: {c,z,i,d,s}, fullbin: <<fullbin::size(32)>>}), do: ExPrintf.sprintf("%04x %08x %-12s %-7s %s, %s", [addr,fullbin,disasm_c(<<con::size(4)>>),"sumnz",tohex(0,d),"#{imm?(i)}#{tohex(0,s)}"])
...
#                                           EEEE 0100000 CZI DDDDDDDDD SSSSSSSSS        TESTB   D,S/#       WC/WZ
  def testb(all=%{addr: addr, con: con, instr: "TESTB", vars: {c,z,i,d,s}, fullbin: <<fullbin::size(32)>>}), do: ExPrintf.sprintf("%04x %08x %-12s %-7s %s, %s", [addr,fullbin,disasm_c(<<con::size(4)>>),"testb",tohex(0,d),"#{imm?(i)}#{tohex(0,s)}"])
...
#                                           EEEE 0100001 CZI DDDDDDDDD SSSSSSSSS        TESTBN  D,S/#       WC/WZ
  def testbn(all=%{addr: addr, con: con, instr: "TESTBN", vars: {c,z,i,d,s}, fullbin: <<fullbin::size(32)>>}), do: ExPrintf.sprintf("%04x %08x %-12s %-7s %s, %s", [addr,fullbin,disasm_c(<<con::size(4)>>),"testbn",tohex(0,d),"#{imm?(i)}#{tohex(0,s)}"])
...
#                                           EEEE 0101000 CZI DDDDDDDDD SSSSSSSSS        AND     D,S/#       {WC/WZ/WCZ}
  def aand(all=%{addr: addr, con: con, instr: "AND", vars: {c,z,i,d,s}, fullbin: <<fullbin::size(32)>>}), do: ExPrintf.sprintf("%04x %08x %-12s %-7s %s, %s", [addr,fullbin,disasm_c(<<con::size(4)>>),"and",tohex(0,d),"#{imm?(i)}#{tohex(0,s)}"])

#                                           EEEE 0101001 CZI DDDDDDDDD SSSSSSSSS        ANDN    D,S/#       {WC/WZ/WCZ}
  def andn(all=%{addr: addr, con: con, instr: "ANDN", vars: {c,z,i,d,s}, fullbin: <<fullbin::size(32)>>}), do: ExPrintf.sprintf("%04x %08x %-12s %-7s %s, %s", [addr,fullbin,disasm_c(<<con::size(4)>>),"andn",tohex(0,d),"#{imm?(i)}#{tohex(0,s)}"])

#                                           EEEE 0101010 CZI DDDDDDDDD SSSSSSSSS        OR      D,S/#       {WC/WZ/WCZ}
  def oor(all=%{addr: addr, con: con, instr: "OR", vars: {c,z,i,d,s}, fullbin: <<fullbin::size(32)>>}), do: ExPrintf.sprintf("%04x %08x %-12s %-7s %s, %s", [addr,fullbin,disasm_c(<<con::size(4)>>),"or",tohex(0,d),"#{imm?(i)}#{tohex(0,s)}"])

#                                           EEEE 0101011 CZI DDDDDDDDD SSSSSSSSS        XOR     D,S/#       {WC/WZ/WCZ}
  def xor(all=%{addr: addr, con: con, instr: "XOR", vars: {c,z,i,d,s}, fullbin: <<fullbin::size(32)>>}), do: ExPrintf.sprintf("%04x %08x %-12s %-7s %s, %s", [addr,fullbin,disasm_c(<<con::size(4)>>),"xor",tohex(0,d),"#{imm?(i)}#{tohex(0,s)}"])

#                                           EEEE 0101100 CZI DDDDDDDDD SSSSSSSSS        MUXC    D,S/#       {WC/WZ/WCZ}
  def muxc(all=%{addr: addr, con: con, instr: "MUXC", vars: {c,z,i,d,s}, fullbin: <<fullbin::size(32)>>}), do: ExPrintf.sprintf("%04x %08x %-12s %-7s %s, %s", [addr,fullbin,disasm_c(<<con::size(4)>>),"muxc",tohex(0,d),"#{imm?(i)}#{tohex(0,s)}"])

#                                           EEEE 0101101 CZI DDDDDDDDD SSSSSSSSS        MUXNC   D,S/#       {WC/WZ/WCZ}
  def muxnc(all=%{addr: addr, con: con, instr: "MUXNC", vars: {c,z,i,d,s}, fullbin: <<fullbin::size(32)>>}), do: ExPrintf.sprintf("%04x %08x %-12s %-7s %s, %s", [addr,fullbin,disasm_c(<<con::size(4)>>),"muxnc",tohex(0,d),"#{imm?(i)}#{tohex(0,s)}"])

#                                           EEEE 0101110 CZI DDDDDDDDD SSSSSSSSS        MUXZ    D,S/#       {WC/WZ/WCZ}
  def muxz(all=%{addr: addr, con: con, instr: "MUXZ", vars: {c,z,i,d,s}, fullbin: <<fullbin::size(32)>>}), do: ExPrintf.sprintf("%04x %08x %-12s %-7s %s, %s", [addr,fullbin,disasm_c(<<con::size(4)>>),"muxz",tohex(0,d),"#{imm?(i)}#{tohex(0,s)}"])

#                                           EEEE 0101111 CZI DDDDDDDDD SSSSSSSSS        MUXNZ   D,S/#       {WC/WZ/WCZ}
  def muxnz(all=%{addr: addr, con: con, instr: "MUXNZ", vars: {c,z,i,d,s}, fullbin: <<fullbin::size(32)>>}), do: ExPrintf.sprintf("%04x %08x %-12s %-7s %s, %s", [addr,fullbin,disasm_c(<<con::size(4)>>),"muxnz",tohex(0,d),"#{imm?(i)}#{tohex(0,s)}"])

#                                           EEEE 0110000 CZI DDDDDDDDD SSSSSSSSS        MOV     D,S/#       {WC/WZ/WCZ}
  def mov(all=%{addr: addr, con: con, instr: "MOV", vars: {c,z,i,d,s}, fullbin: <<fullbin::size(32)>>}), do: ExPrintf.sprintf("%04x %08x %-12s %-7s %s, %s", [addr,fullbin,disasm_c(<<con::size(4)>>),"mov",tohex(0,d),"#{imm?(i)}#{tohex(0,s)}"])

#                                           EEEE 0110001 CZI DDDDDDDDD SSSSSSSSS        NOT     D,S/#       {WC/WZ/WCZ}
  def not(all=%{addr: addr, con: con, instr: "NOT", vars: {c,z,i,d,s}, fullbin: <<fullbin::size(32)>>}), do: ExPrintf.sprintf("%04x %08x %-12s %-7s %s, %s", [addr,fullbin,disasm_c(<<con::size(4)>>),"not",tohex(0,d),"#{imm?(i)}#{tohex(0,s)}"])

#                                           EEEE 0110010 CZI DDDDDDDDD SSSSSSSSS        ABS     D,S/#       {WC/WZ/WCZ}
  def abs(all=%{addr: addr, con: con, instr: "ABS", vars: {c,z,i,d,s}, fullbin: <<fullbin::size(32)>>}), do: ExPrintf.sprintf("%04x %08x %-12s %-7s %s, %s", [addr,fullbin,disasm_c(<<con::size(4)>>),"abs",tohex(0,d),"#{imm?(i)}#{tohex(0,s)}"])

#                                           EEEE 0110011 CZI DDDDDDDDD SSSSSSSSS        NEG     D,S/#       {WC/WZ/WCZ}
  def neg(all=%{addr: addr, con: con, instr: "NEG", vars: {c,z,i,d,s}, fullbin: <<fullbin::size(32)>>}), do: ExPrintf.sprintf("%04x %08x %-12s %-7s %s, %s", [addr,fullbin,disasm_c(<<con::size(4)>>),"neg",tohex(0,d),"#{imm?(i)}#{tohex(0,s)}"])

#                                           EEEE 0110100 CZI DDDDDDDDD SSSSSSSSS        NEGC    D,S/#       {WC/WZ/WCZ}
  def negc(all=%{addr: addr, con: con, instr: "NEGC", vars: {c,z,i,d,s}, fullbin: <<fullbin::size(32)>>}), do: ExPrintf.sprintf("%04x %08x %-12s %-7s %s, %s", [addr,fullbin,disasm_c(<<con::size(4)>>),"negc",tohex(0,d),"#{imm?(i)}#{tohex(0,s)}"])

#                                           EEEE 0110101 CZI DDDDDDDDD SSSSSSSSS        NEGNC   D,S/#       {WC/WZ/WCZ}
  def negnc(all=%{addr: addr, con: con, instr: "NEGNC", vars: {c,z,i,d,s}, fullbin: <<fullbin::size(32)>>}), do: ExPrintf.sprintf("%04x %08x %-12s %-7s %s, %s", [addr,fullbin,disasm_c(<<con::size(4)>>),"negnc",tohex(0,d),"#{imm?(i)}#{tohex(0,s)}"])

#                                           EEEE 0110110 CZI DDDDDDDDD SSSSSSSSS        NEGZ    D,S/#       {WC/WZ/WCZ}
  def negz(all=%{addr: addr, con: con, instr: "NEGZ", vars: {c,z,i,d,s}, fullbin: <<fullbin::size(32)>>}), do: ExPrintf.sprintf("%04x %08x %-12s %-7s %s, %s", [addr,fullbin,disasm_c(<<con::size(4)>>),"negz",tohex(0,d),"#{imm?(i)}#{tohex(0,s)}"])

#                                           EEEE 0110111 CZI DDDDDDDDD SSSSSSSSS        NEGNZ   D,S/#       {WC/WZ/WCZ}
  def negnz(all=%{addr: addr, con: con, instr: "NEGNZ", vars: {c,z,i,d,s}, fullbin: <<fullbin::size(32)>>}), do: ExPrintf.sprintf("%04x %08x %-12s %-7s %s, %s", [addr,fullbin,disasm_c(<<con::size(4)>>),"negnz",tohex(0,d),"#{imm?(i)}#{tohex(0,s)}"])

#                                           EEEE 0111000 CZI DDDDDDDDD SSSSSSSSS        INCMOD  D,S/#       {WC/WZ/WCZ}
  def incmod(all=%{addr: addr, con: con, instr: "INCMOD", vars: {c,z,i,d,s}, fullbin: <<fullbin::size(32)>>}), do: ExPrintf.sprintf("%04x %08x %-12s %-7s %s, %s", [addr,fullbin,disasm_c(<<con::size(4)>>),"incmod",tohex(0,d),"#{imm?(i)}#{tohex(0,s)}"])

#                                           EEEE 0111001 CZI DDDDDDDDD SSSSSSSSS        DECMOD  D,S/#       {WC/WZ/WCZ}
  def decmod(all=%{addr: addr, con: con, instr: "DECMOD", vars: {c,z,i,d,s}, fullbin: <<fullbin::size(32)>>}), do: ExPrintf.sprintf("%04x %08x %-12s %-7s %s, %s", [addr,fullbin,disasm_c(<<con::size(4)>>),"decmod",tohex(0,d),"#{imm?(i)}#{tohex(0,s)}"])

#                                           EEEE 0111010 CZI DDDDDDDDD SSSSSSSSS        ZEROX   D,S/#       {WC/WZ/WCZ}
  def zerox(all=%{addr: addr, con: con, instr: "ZEROX", vars: {c,z,i,d,s}, fullbin: <<fullbin::size(32)>>}), do: ExPrintf.sprintf("%04x %08x %-12s %-7s %s, %s", [addr,fullbin,disasm_c(<<con::size(4)>>),"zerox",tohex(0,d),"#{imm?(i)}#{tohex(0,s)}"])

#                                           EEEE 0111011 CZI DDDDDDDDD SSSSSSSSS        SIGNX   D,S/#       {WC/WZ/WCZ}
  def signx(all=%{addr: addr, con: con, instr: "SIGNX", vars: {c,z,i,d,s}, fullbin: <<fullbin::size(32)>>}), do: ExPrintf.sprintf("%04x %08x %-12s %-7s %s, %s", [addr,fullbin,disasm_c(<<con::size(4)>>),"signx",tohex(0,d),"#{imm?(i)}#{tohex(0,s)}"])

#                                           EEEE 0111100 CZI DDDDDDDDD SSSSSSSSS        ENCOD   D,S/#       {WC/WZ/WCZ}
  def encod(all=%{addr: addr, con: con, instr: "ENCOD", vars: {c,z,i,d,s}, fullbin: <<fullbin::size(32)>>}), do: ExPrintf.sprintf("%04x %08x %-12s %-7s %s, %s", [addr,fullbin,disasm_c(<<con::size(4)>>),"encod",tohex(0,d),"#{imm?(i)}#{tohex(0,s)}"])

#                                           EEEE 0111101 CZI DDDDDDDDD SSSSSSSSS        ONES    D,S/#       {WC/WZ/WCZ}
  def ones(all=%{addr: addr, con: con, instr: "ONES", vars: {c,z,i,d,s}, fullbin: <<fullbin::size(32)>>}), do: ExPrintf.sprintf("%04x %08x %-12s %-7s %s, %s", [addr,fullbin,disasm_c(<<con::size(4)>>),"ones",tohex(0,d),"#{imm?(i)}#{tohex(0,s)}"])

#                                           EEEE 0111110 CZI DDDDDDDDD SSSSSSSSS        TEST    D,S/#       {WC/WZ/WCZ}
  def test(all=%{addr: addr, con: con, instr: "TEST", vars: {c,z,i,d,s}, fullbin: <<fullbin::size(32)>>}), do: ExPrintf.sprintf("%04x %08x %-12s %-7s %s, %s", [addr,fullbin,disasm_c(<<con::size(4)>>),"test",tohex(0,d),"#{imm?(i)}#{tohex(0,s)}"])

#                                           EEEE 0111111 CZI DDDDDDDDD SSSSSSSSS        TESTN   D,S/#       {WC/WZ/WCZ}
  def testn(all=%{addr: addr, con: con, instr: "TESTN", vars: {c,z,i,d,s}, fullbin: <<fullbin::size(32)>>}), do: ExPrintf.sprintf("%04x %08x %-12s %-7s %s, %s", [addr,fullbin,disasm_c(<<con::size(4)>>),"testn",tohex(0,d),"#{imm?(i)}#{tohex(0,s)}"])
...
#                                           EEEE 1001010 11I DDDDDDDDD SSSSSSSSS        ALTGN   D,S/#
  def altgn(all=%{addr: addr, con: con, instr: "ALTGN", vars: {i,d,s}, fullbin: <<fullbin::size(32)>>}), do: IO.inspect(all)

#                                           EEEE 1001011 00I DDDDDDDDD SSSSSSSSS        ALTSB   D,S/#
  def altsb(all=%{addr: addr, con: con, instr: "ALTSB", vars: {i,d,s}, fullbin: <<fullbin::size(32)>>}), do: IO.inspect(all)

#                                           EEEE 1001011 01I DDDDDDDDD SSSSSSSSS        ALTGB   D,S/#
  def altgb(all=%{addr: addr, con: con, instr: "ALTGB", vars: {i,d,s}, fullbin: <<fullbin::size(32)>>}), do: IO.inspect(all)

#                                           EEEE 1001011 10I DDDDDDDDD SSSSSSSSS        ALTSW   D,S/#
  def altsw(all=%{addr: addr, con: con, instr: "ALTSW", vars: {i,d,s}, fullbin: <<fullbin::size(32)>>}), do: IO.inspect(all)

#                                           EEEE 1001011 11I DDDDDDDDD SSSSSSSSS        ALTGW   D,S/#
  def altgw(all=%{addr: addr, con: con, instr: "ALTGW", vars: {i,d,s}, fullbin: <<fullbin::size(32)>>}), do: IO.inspect(all)

#                                           EEEE 1001100 00I DDDDDDDDD SSSSSSSSS        ALTR    D,S/#
  def altr(all=%{addr: addr, con: con, instr: "ALTR", vars: {i,d,s}, fullbin: <<fullbin::size(32)>>}), do: IO.inspect(all)

#                                           EEEE 1001100 01I DDDDDDDDD SSSSSSSSS        ALTD    D,S/#
  def altd(all=%{addr: addr, con: con, instr: "ALTD", vars: {i,d,s}, fullbin: <<fullbin::size(32)>>}), do: IO.inspect(all)

#                                           EEEE 1001100 10I DDDDDDDDD SSSSSSSSS        ALTS    D,S/#
  def alts(all=%{addr: addr, con: con, instr: "ALTS", vars: {i,d,s}, fullbin: <<fullbin::size(32)>>}), do: IO.inspect(all)

#                                           EEEE 1001100 11I DDDDDDDDD SSSSSSSSS        ALTB    D,S/#
  def altb(all=%{addr: addr, con: con, instr: "ALTB", vars: {i,d,s}, fullbin: <<fullbin::size(32)>>}), do: IO.inspect(all)

#                                           EEEE 1001101 00I DDDDDDDDD SSSSSSSSS        ALTI    D,S/#
  def alti(all=%{addr: addr, con: con, instr: "ALTI", vars: {i,d,s}, fullbin: <<fullbin::size(32)>>}), do: IO.inspect(all)

#                                           EEEE 1001101 01I DDDDDDDDD SSSSSSSSS        SETR    D,S/#
  def setr(all=%{addr: addr, con: con, instr: "SETR", vars: {i,d,s}, fullbin: <<fullbin::size(32)>>}), do: IO.inspect(all)
...
#                                           EEEE 1001101 11I DDDDDDDDD SSSSSSSSS        SETS    D,S/#
  def sets(all=%{addr: addr, con: con, instr: "SETS", vars: {i,d,s}, fullbin: <<fullbin::size(32)>>}), do: IO.inspect(all)

#                                           EEEE 1001110 00I DDDDDDDDD SSSSSSSSS        DECOD   D,S/#
  def decod(all=%{addr: addr, con: con, instr: "DECOD", vars: {i,d,s}, fullbin: <<fullbin::size(32)>>}), do: IO.inspect(all)

#                                           EEEE 1001110 01I DDDDDDDDD SSSSSSSSS        BMASK   D,S/#
  def bmask(all=%{addr: addr, con: con, instr: "BMASK", vars: {i,d,s}, fullbin: <<fullbin::size(32)>>}), do: IO.inspect(all)

#                                           EEEE 1001110 10I DDDDDDDDD SSSSSSSSS        CRCBIT  D,S/#
  def crcbit(all=%{addr: addr, con: con, instr: "CRCBIT", vars: {i,d,s}, fullbin: <<fullbin::size(32)>>}), do: IO.inspect(all)

#                                           EEEE 1001110 11I DDDDDDDDD SSSSSSSSS        CRCNIB  D,S/#
  def crcnib(all=%{addr: addr, con: con, instr: "CRCNIB", vars: {i,d,s}, fullbin: <<fullbin::size(32)>>}), do: IO.inspect(all)

#                                           EEEE 1001111 00I DDDDDDDDD SSSSSSSSS        MUXNITS D,S/#
  def muxnits(all=%{addr: addr, con: con, instr: "MUXNITS", vars: {i,d,s}, fullbin: <<fullbin::size(32)>>}), do: IO.inspect(all)

#                                           EEEE 1001111 01I DDDDDDDDD SSSSSSSSS        MUXNIBS D,S/#
  def muxnibs(all=%{addr: addr, con: con, instr: "MUXNIBS", vars: {i,d,s}, fullbin: <<fullbin::size(32)>>}), do: IO.inspect(all)

#                                           EEEE 1001111 10I DDDDDDDDD SSSSSSSSS        MUXQ    D,S/#
  def muxq(all=%{addr: addr, con: con, instr: "MUXQ", vars: {i,d,s}, fullbin: <<fullbin::size(32)>>}), do: IO.inspect(all)

#                                           EEEE 1001111 11I DDDDDDDDD SSSSSSSSS        MOVBYTS D,S/#
  def movbyts(all=%{addr: addr, con: con, instr: "MOVBYTS", vars: {i,d,s}, fullbin: <<fullbin::size(32)>>}), do: IO.inspect(all)

#                                           EEEE 1010000 0ZI DDDDDDDDD SSSSSSSSS        MUL     D,S/#       {WZ}
  def mul(all=%{addr: addr, con: con, instr: "MUL", vars: {z,i,d,s}, fullbin: <<fullbin::size(32)>>}), do: IO.inspect(all)

#                                           EEEE 1010000 1ZI DDDDDDDDD SSSSSSSSS        MULS    D,S/#       {WZ}
  def muls(all=%{addr: addr, con: con, instr: "MULS", vars: {z,i,d,s}, fullbin: <<fullbin::size(32)>>}), do: IO.inspect(all)

#                                           EEEE 1010001 0ZI DDDDDDDDD SSSSSSSSS        SCA     D,S/#       {WZ}
  def sca(all=%{addr: addr, con: con, instr: "SCA", vars: {z,i,d,s}, fullbin: <<fullbin::size(32)>>}), do: IO.inspect(all)

#                                           EEEE 1010001 1ZI DDDDDDDDD SSSSSSSSS        SCAS    D,S/#       {WZ}
  def scas(all=%{addr: addr, con: con, instr: "SCAS", vars: {z,i,d,s}, fullbin: <<fullbin::size(32)>>}), do: IO.inspect(all)

#                                           EEEE 1010010 00I DDDDDDDDD SSSSSSSSS        ADDPIX  D,S/#
  def addpix(all=%{addr: addr, con: con, instr: "ADDPIX", vars: {i,d,s}, fullbin: <<fullbin::size(32)>>}), do: IO.inspect(all)

#                                           EEEE 1010010 01I DDDDDDDDD SSSSSSSSS        MULPIX  D,S/#
  def mulpix(all=%{addr: addr, con: con, instr: "MULPIX", vars: {i,d,s}, fullbin: <<fullbin::size(32)>>}), do: IO.inspect(all)

#                                           EEEE 1010010 10I DDDDDDDDD SSSSSSSSS        BLNPIX  D,S/#
  def blnpix(all=%{addr: addr, con: con, instr: "BLNPIX", vars: {i,d,s}, fullbin: <<fullbin::size(32)>>}), do: IO.inspect(all)

#                                           EEEE 1010010 11I DDDDDDDDD SSSSSSSSS        MIXPIX  D,S/#
  def mixpix(all=%{addr: addr, con: con, instr: "MIXPIX", vars: {i,d,s}, fullbin: <<fullbin::size(32)>>}), do: IO.inspect(all)

#                                           EEEE 1010011 00I DDDDDDDDD SSSSSSSSS        ADDCT1  D,S/#
  def addct1(all=%{addr: addr, con: con, instr: "ADDCT1", vars: {i,d,s}, fullbin: <<fullbin::size(32)>>}), do: IO.inspect(all)

#                                           EEEE 1010011 01I DDDDDDDDD SSSSSSSSS        ADDCT2  D,S/#
  def addct2(all=%{addr: addr, con: con, instr: "ADDCT2", vars: {i,d,s}, fullbin: <<fullbin::size(32)>>}), do: IO.inspect(all)

#                                           EEEE 1010011 10I DDDDDDDDD SSSSSSSSS        ADDCT3  D,S/#
  def addct3(all=%{addr: addr, con: con, instr: "ADDCT3", vars: {i,d,s}, fullbin: <<fullbin::size(32)>>}), do: IO.inspect(all)

#                                           EEEE 1010011 11I DDDDDDDDD SSSSSSSSS        WMLONG  D,S/#/PTRx
  def wmlong(all=%{addr: addr, con: con, instr: "WMLONG", vars: {i,d,s}, fullbin: <<fullbin::size(32)>>}), do: IO.inspect(all)

#                                           EEEE 1010100 C0I DDDDDDDDD SSSSSSSSS        RQPIN   D,S/#       {WC}
  def rqpin(all=%{addr: addr, con: con, instr: "RQPIN", vars: {c,<< 0b0::size(1) >>,i,d,s}, fullbin: <<fullbin::size(32)>>}), do: IO.inspect(all)

#                                           EEEE 1010100 C1I DDDDDDDDD SSSSSSSSS        RDPIN   D,S/#       {WC}
  def rdpin(all=%{addr: addr, con: con, instr: "RDPIN", vars: {c,<< 0b1::size(1) >>,i,d,s}, fullbin: <<fullbin::size(32)>>}), do: IO.inspect(all)

#                                           EEEE 1010101 CZI DDDDDDDDD SSSSSSSSS        RDLUT   D,S/#       {WC/WZ/WCZ}
  def rdlut(all=%{addr: addr, con: con, instr: "RDLUT", vars: {c,z,i,d,s}, fullbin: <<fullbin::size(32)>>}), do: ExPrintf.sprintf("%04x %08x %-12s %-7s %s, %s", [addr,fullbin,disasm_c(<<con::size(4)>>),"rdlut",tohex(0,d),"#{imm?(i)}#{tohex(0,s)}"])

#                                           EEEE 1010110 CZI DDDDDDDDD SSSSSSSSS        RDBYTE  D,S/#/PTRx  {WC/WZ/WCZ}
  def rdbyte(all=%{addr: addr, con: con, instr: "RDBYTE", vars: {c,z,i,d,s}, fullbin: <<fullbin::size(32)>>}), do: ExPrintf.sprintf("%04x %08x %-12s %-7s %s, %s", [addr,fullbin,disasm_c(<<con::size(4)>>),"rdbyte",tohex(0,d),"#{imm?(i)}#{tohex(0,s)}"])

#                                           EEEE 1010111 CZI DDDDDDDDD SSSSSSSSS        RDWORD  D,S/#/PTRx  {WC/WZ/WCZ}
  def rdword(all=%{addr: addr, con: con, instr: "RDWORD", vars: {c,z,i,d,s}, fullbin: <<fullbin::size(32)>>}), do: ExPrintf.sprintf("%04x %08x %-12s %-7s %s, %s", [addr,fullbin,disasm_c(<<con::size(4)>>),"rdword",tohex(0,d),"#{imm?(i)}#{tohex(0,s)}"])

#                                           EEEE 1011000 CZI DDDDDDDDD SSSSSSSSS        RDLONG  D,S/#/PTRx  {WC/WZ/WCZ}
  def rdlong(all=%{addr: addr, con: con, instr: "RDLONG", vars: {c,z,i,d,s}, fullbin: <<fullbin::size(32)>>}), do: ExPrintf.sprintf("%04x %08x %-12s %-7s %s, %s", [addr,fullbin,disasm_c(<<con::size(4)>>),"rdlong",tohex(0,d),"#{imm?(i)}#{tohex(0,s)}"])

#                                           EEEE 1011001 CZI DDDDDDDDD SSSSSSSSS        CALLD   D,S/#rel9   {WC/WZ/WCZ}
  def calld(all=%{addr: addr, con: con, instr: "CALLD", vars: {c,z,i,d,s}, fullbin: <<fullbin::size(32)>>}), do: ExPrintf.sprintf("%04x %08x %-12s %-7s %s, %s", [addr,fullbin,disasm_c(<<con::size(4)>>),"calld",tohex(0,d),"#{imm?(i)}#{tohex(0,s)}"])
...
#                                           EEEE 1011011 11I DDDDDDDDD SSSSSSSSS        DJNF    D,S/#rel9
  def djnf(all=%{addr: addr, con: con, instr: "DJNF", vars: {i,d,s}, fullbin: <<fullbin::size(32)>>}), do: IO.inspect(all)

#                                           EEEE 1011100 00I DDDDDDDDD SSSSSSSSS        IJZ     D,S/#rel9
  def ijz(all=%{addr: addr, con: con, instr: "IJZ", vars: {i,d,s}, fullbin: <<fullbin::size(32)>>}), do: IO.inspect(all)

#                                           EEEE 1011100 01I DDDDDDDDD SSSSSSSSS        IJNZ    D,S/#rel9
  def ijnz(all=%{addr: addr, con: con, instr: "IJNZ", vars: {i,d,s}, fullbin: <<fullbin::size(32)>>}), do: IO.inspect(all)

#                                           EEEE 1011100 10I DDDDDDDDD SSSSSSSSS        TJZ     D,S/#rel9
  def tjz(all=%{addr: addr, con: con, instr: "TJZ", vars: {i,d,s}, fullbin: <<fullbin::size(32)>>}), do: IO.inspect(all)

#                                           EEEE 1011100 11I DDDDDDDDD SSSSSSSSS        TJNZ    D,S/#rel9
  def tjnz(all=%{addr: addr, con: con, instr: "TJNZ", vars: {i,d,s}, fullbin: <<fullbin::size(32)>>}), do: IO.inspect(all)

#                                           EEEE 1011101 00I DDDDDDDDD SSSSSSSSS        TJF     D,S/#rel9
  def tjf(all=%{addr: addr, con: con, instr: "TJF", vars: {i,d,s}, fullbin: <<fullbin::size(32)>>}), do: IO.inspect(all)

#                                           EEEE 1011101 01I DDDDDDDDD SSSSSSSSS        TJNF    D,S/#rel9
  def tjnf(all=%{addr: addr, con: con, instr: "TJNF", vars: {i,d,s}, fullbin: <<fullbin::size(32)>>}), do: IO.inspect(all)

#                                           EEEE 1011101 10I DDDDDDDDD SSSSSSSSS        TJS     D,S/#rel9
  def tjs(all=%{addr: addr, con: con, instr: "TJS", vars: {i,d,s}, fullbin: <<fullbin::size(32)>>}), do: IO.inspect(all)

#                                           EEEE 1011101 11I DDDDDDDDD SSSSSSSSS        TJNS    D,S/#rel9
  def tjns(all=%{addr: addr, con: con, instr: "TJNS", vars: {i,d,s}, fullbin: <<fullbin::size(32)>>}), do: IO.inspect(all)

#                                           EEEE 1011110 00I DDDDDDDDD SSSSSSSSS        TJV     D,S/#rel9
  def tjv(all=%{addr: addr, con: con, instr: "TJV", vars: {i,d,s}, fullbin: <<fullbin::size(32)>>}), do: IO.inspect(all)

#                                           EEEE 1011110 01I 000000000 SSSSSSSSS        JINT    S/#rel9
  def jint(all=%{addr: addr, con: con, instr: "JINT", vars: {i,<< 0b000000000::size(9) >>,s}, fullbin: <<fullbin::size(32)>>}), do: IO.inspect(all)

#                                           EEEE 1011110 01I 000000001 SSSSSSSSS        JCT1    S/#rel9
  def jct1(all=%{addr: addr, con: con, instr: "JCT1", vars: {i,<< 0b00000000::size(8) >>,<< 0b1::size(1) >>,s}, fullbin: <<fullbin::size(32)>>}), do: IO.inspect(all)

#                                           EEEE 1011110 01I 000000010 SSSSSSSSS        JCT2    S/#rel9
  def jct2(all=%{addr: addr, con: con, instr: "JCT2", vars: {i,<< 0b0000000::size(7) >>,<< 0b1::size(1) >>,<< 0b0::size(1) >>,s}, fullbin: <<fullbin::size(32)>>}), do: IO.inspect(all)

#                                           EEEE 1011110 01I 000000011 SSSSSSSSS        JCT3    S/#rel9
  def jct3(all=%{addr: addr, con: con, instr: "JCT3", vars: {i,<< 0b0000000::size(7) >>,<< 0b11::size(2) >>,s}, fullbin: <<fullbin::size(32)>>}), do: IO.inspect(all)

#                                           EEEE 1011110 01I 000000100 SSSSSSSSS        JSE1    S/#rel9
  def jse1(all=%{addr: addr, con: con, instr: "JSE1", vars: {i,<< 0b000000::size(6) >>,<< 0b1::size(1) >>,<< 0b00::size(2) >>,s}, fullbin: <<fullbin::size(32)>>}), do: IO.inspect(all)

#                                           EEEE 1011110 01I 000000101 SSSSSSSSS        JSE2    S/#rel9
  def jse2(all=%{addr: addr, con: con, instr: "JSE2", vars: {i,<< 0b000000::size(6) >>,<< 0b1::size(1) >>,<< 0b0::size(1) >>,<< 0b1::size(1) >>,s}, fullbin: <<fullbin::size(32)>>}), do: IO.inspect(all)

#                                           EEEE 1011110 01I 000000110 SSSSSSSSS        JSE3    S/#rel9
  def jse3(all=%{addr: addr, con: con, instr: "JSE3", vars: {i,<< 0b000000::size(6) >>,<< 0b11::size(2) >>,<< 0b0::size(1) >>,s}, fullbin: <<fullbin::size(32)>>}), do: IO.inspect(all)

#                                           EEEE 1011110 01I 000000111 SSSSSSSSS        JSE4    S/#rel9
  def jse4(all=%{addr: addr, con: con, instr: "JSE4", vars: {i,<< 0b000000::size(6) >>,<< 0b111::size(3) >>,s}, fullbin: <<fullbin::size(32)>>}), do: IO.inspect(all)

#                                           EEEE 1011110 01I 000001000 SSSSSSSSS        JPAT    S/#rel9
  def jpat(all=%{addr: addr, con: con, instr: "JPAT", vars: {i,<< 0b00000::size(5) >>,<< 0b1::size(1) >>,<< 0b000::size(3) >>,s}, fullbin: <<fullbin::size(32)>>}), do: IO.inspect(all)

#                                           EEEE 1011110 01I 000001001 SSSSSSSSS        JFBW    S/#rel9
  def jfbw(all=%{addr: addr, con: con, instr: "JFBW", vars: {i,<< 0b00000::size(5) >>,<< 0b1::size(1) >>,<< 0b00::size(2) >>,<< 0b1::size(1) >>,s}, fullbin: <<fullbin::size(32)>>}), do: IO.inspect(all)

#                                           EEEE 1011110 01I 000001010 SSSSSSSSS        JXMT    S/#rel9
  def jxmt(all=%{addr: addr, con: con, instr: "JXMT", vars: {i,<< 0b00000::size(5) >>,<< 0b1::size(1) >>,<< 0b0::size(1) >>,<< 0b1::size(1) >>,<< 0b0::size(1) >>,s}, fullbin: <<fullbin::size(32)>>}), do: IO.inspect(all)

#                                           EEEE 1011110 01I 000001011 SSSSSSSSS        JXFI    S/#rel9
  def jxfi(all=%{addr: addr, con: con, instr: "JXFI", vars: {i,<< 0b00000::size(5) >>,<< 0b1::size(1) >>,<< 0b0::size(1) >>,<< 0b11::size(2) >>,s}, fullbin: <<fullbin::size(32)>>}), do: IO.inspect(all)

#                                           EEEE 1011110 01I 000001100 SSSSSSSSS        JXRO    S/#rel9
  def jxro(all=%{addr: addr, con: con, instr: "JXRO", vars: {i,<< 0b00000::size(5) >>,<< 0b11::size(2) >>,<< 0b00::size(2) >>,s}, fullbin: <<fullbin::size(32)>>}), do: IO.inspect(all)

#                                           EEEE 1011110 01I 000001101 SSSSSSSSS        JXRL    S/#rel9
  def jxrl(all=%{addr: addr, con: con, instr: "JXRL", vars: {i,<< 0b00000::size(5) >>,<< 0b11::size(2) >>,<< 0b0::size(1) >>,<< 0b1::size(1) >>,s}, fullbin: <<fullbin::size(32)>>}), do: IO.inspect(all)

#                                           EEEE 1011110 01I 000001110 SSSSSSSSS        JATN    S/#rel9
  def jatn(all=%{addr: addr, con: con, instr: "JATN", vars: {i,<< 0b00000::size(5) >>,<< 0b111::size(3) >>,<< 0b0::size(1) >>,s}, fullbin: <<fullbin::size(32)>>}), do: IO.inspect(all)

#                                           EEEE 1011110 01I 000001111 SSSSSSSSS        JQMT    S/#rel9
  def jqmt(all=%{addr: addr, con: con, instr: "JQMT", vars: {i,<< 0b00000::size(5) >>,<< 0b1111::size(4) >>,s}, fullbin: <<fullbin::size(32)>>}), do: IO.inspect(all)

#                                           EEEE 1011110 01I 000010000 SSSSSSSSS        JNINT   S/#rel9
  def jnint(all=%{addr: addr, con: con, instr: "JNINT", vars: {i,<< 0b0000::size(4) >>,<< 0b1::size(1) >>,<< 0b0000::size(4) >>,s}, fullbin: <<fullbin::size(32)>>}), do: IO.inspect(all)

#                                           EEEE 1011110 01I 000010001 SSSSSSSSS        JNCT1   S/#rel9
  def jnct1(all=%{addr: addr, con: con, instr: "JNCT1", vars: {i,<< 0b0000::size(4) >>,<< 0b1::size(1) >>,<< 0b000::size(3) >>,<< 0b1::size(1) >>,s}, fullbin: <<fullbin::size(32)>>}), do: IO.inspect(all)

#                                           EEEE 1011110 01I 000010010 SSSSSSSSS        JNCT2   S/#rel9
  def jnct2(all=%{addr: addr, con: con, instr: "JNCT2", vars: {i,<< 0b0000::size(4) >>,<< 0b1::size(1) >>,<< 0b00::size(2) >>,<< 0b1::size(1) >>,<< 0b0::size(1) >>,s}, fullbin: <<fullbin::size(32)>>}), do: IO.inspect(all)

#                                           EEEE 1011110 01I 000010011 SSSSSSSSS        JNCT3   S/#rel9
  def jnct3(all=%{addr: addr, con: con, instr: "JNCT3", vars: {i,<< 0b0000::size(4) >>,<< 0b1::size(1) >>,<< 0b00::size(2) >>,<< 0b11::size(2) >>,s}, fullbin: <<fullbin::size(32)>>}), do: IO.inspect(all)

#                                           EEEE 1011110 01I 000010100 SSSSSSSSS        JNSE1   S/#rel9
  def jnse1(all=%{addr: addr, con: con, instr: "JNSE1", vars: {i,<< 0b0000::size(4) >>,<< 0b1::size(1) >>,<< 0b0::size(1) >>,<< 0b1::size(1) >>,<< 0b00::size(2) >>,s}, fullbin: <<fullbin::size(32)>>}), do: IO.inspect(all)

#                                           EEEE 1011110 01I 000010101 SSSSSSSSS        JNSE2   S/#rel9
  def jnse2(all=%{addr: addr, con: con, instr: "JNSE2", vars: {i,<< 0b0000::size(4) >>,<< 0b1::size(1) >>,<< 0b0::size(1) >>,<< 0b1::size(1) >>,<< 0b0::size(1) >>,<< 0b1::size(1) >>,s}, fullbin: <<fullbin::size(32)>>}), do: IO.inspect(all)

#                                           EEEE 1011110 01I 000010110 SSSSSSSSS        JNSE3   S/#rel9
  def jnse3(all=%{addr: addr, con: con, instr: "JNSE3", vars: {i,<< 0b0000::size(4) >>,<< 0b1::size(1) >>,<< 0b0::size(1) >>,<< 0b11::size(2) >>,<< 0b0::size(1) >>,s}, fullbin: <<fullbin::size(32)>>}), do: IO.inspect(all)

#                                           EEEE 1011110 01I 000010111 SSSSSSSSS        JNSE4   S/#rel9
  def jnse4(all=%{addr: addr, con: con, instr: "JNSE4", vars: {i,<< 0b0000::size(4) >>,<< 0b1::size(1) >>,<< 0b0::size(1) >>,<< 0b111::size(3) >>,s}, fullbin: <<fullbin::size(32)>>}), do: IO.inspect(all)

#                                           EEEE 1011110 01I 000011000 SSSSSSSSS        JNPAT   S/#rel9
  def jnpat(all=%{addr: addr, con: con, instr: "JNPAT", vars: {i,<< 0b0000::size(4) >>,<< 0b11::size(2) >>,<< 0b000::size(3) >>,s}, fullbin: <<fullbin::size(32)>>}), do: IO.inspect(all)

#                                           EEEE 1011110 01I 000011001 SSSSSSSSS        JNFBW   S/#rel9
  def jnfbw(all=%{addr: addr, con: con, instr: "JNFBW", vars: {i,<< 0b0000::size(4) >>,<< 0b11::size(2) >>,<< 0b00::size(2) >>,<< 0b1::size(1) >>,s}, fullbin: <<fullbin::size(32)>>}), do: IO.inspect(all)

#                                           EEEE 1011110 01I 000011010 SSSSSSSSS        JNXMT   S/#rel9
  def jnxmt(all=%{addr: addr, con: con, instr: "JNXMT", vars: {i,<< 0b0000::size(4) >>,<< 0b11::size(2) >>,<< 0b0::size(1) >>,<< 0b1::size(1) >>,<< 0b0::size(1) >>,s}, fullbin: <<fullbin::size(32)>>}), do: IO.inspect(all)

#                                           EEEE 1011110 01I 000011011 SSSSSSSSS        JNXFI   S/#rel9
  def jnxfi(all=%{addr: addr, con: con, instr: "JNXFI", vars: {i,<< 0b0000::size(4) >>,<< 0b11::size(2) >>,<< 0b0::size(1) >>,<< 0b11::size(2) >>,s}, fullbin: <<fullbin::size(32)>>}), do: IO.inspect(all)

#                                           EEEE 1011110 01I 000011100 SSSSSSSSS        JNXRO   S/#rel9
  def jnxro(all=%{addr: addr, con: con, instr: "JNXRO", vars: {i,<< 0b0000::size(4) >>,<< 0b111::size(3) >>,<< 0b00::size(2) >>,s}, fullbin: <<fullbin::size(32)>>}), do: IO.inspect(all)

#                                           EEEE 1011110 01I 000011101 SSSSSSSSS        JNXRL   S/#rel9
  def jnxrl(all=%{addr: addr, con: con, instr: "JNXRL", vars: {i,<< 0b0000::size(4) >>,<< 0b111::size(3) >>,<< 0b0::size(1) >>,<< 0b1::size(1) >>,s}, fullbin: <<fullbin::size(32)>>}), do: IO.inspect(all)

#                                           EEEE 1011110 01I 000011110 SSSSSSSSS        JNATN   S/#rel9
  def jnatn(all=%{addr: addr, con: con, instr: "JNATN", vars: {i,<< 0b0000::size(4) >>,<< 0b1111::size(4) >>,<< 0b0::size(1) >>,s}, fullbin: <<fullbin::size(32)>>}), do: IO.inspect(all)
...
#                                           EEEE 1101011 00L DDDDDDDDD 000000011        COGSTOP D/#
  def cogstop(all=%{addr: addr, con: con, instr: "COGSTOP", vars: {l,d,<< 0b0000000::size(7) >>,<< 0b11::size(2) >>}, fullbin: <<fullbin::size(32)>>}) do
    asm = "#{tohex4(addr)} #{tohex8(fullbin)}              cogstop #{imm?(l)}#{tohex(0,d)}"
  end
...
#                                           EEEE 1101011 CZL DDDDDDDDD 000011011        GETRND  {D}         {WC/WZ/WCZ}
  def getrnd(all=%{addr: addr, con: con, instr: "GETRND", vars: {c,z,l,d,<< 0b0000::size(4) >>,<< 0b11::size(2) >>,<< 0b0::size(1) >>,<< 0b11::size(2) >>}, fullbin: <<fullbin::size(32)>>}), do: IO.inspect(all)
...
#                                           EEEE 1101011 CZL DDDDDDDDD 000011111        WAITX   D/#         {WC/WZ/WCZ}
  def waitx(all=%{addr: addr, con: con, instr: "WAITX", vars: {c,z,l,d,<< 0b0000::size(4) >>,<< 0b11111::size(5) >>}, fullbin: <<fullbin::size(32)>>}), do: IO.inspect(all)
...
#                                           EEEE 1101011 00L DDDDDDDDD 000101001        SETQ2   D/#
  def setq2(all=%{addr: addr, con: con, instr: "SETQ2", vars: {l,d,<< 0b000::size(3) >>,<< 0b1::size(1) >>,<< 0b0::size(1) >>,<< 0b1::size(1) >>,<< 0b00::size(2) >>,<< 0b1::size(1) >>}, fullbin: <<fullbin::size(32)>>}), do: IO.inspect(all)

#                                           EEEE 1101011 00L DDDDDDDDD 000101010        PUSH    D/#
  def push(all=%{addr: addr, con: con, instr: "PUSH", vars: {l,d,<< 0b000::size(3) >>,<< 0b1::size(1) >>,<< 0b0::size(1) >>,<< 0b1::size(1) >>,<< 0b0::size(1) >>,<< 0b1::size(1) >>,<< 0b0::size(1) >>}, fullbin: <<fullbin::size(32)>>}), do: IO.inspect(all)
...
#                                           EEEE 1101011 CZ0 DDDDDDDDD 000101110        CALLA   D           {WC/WZ/WCZ}
  def calla(all=%{addr: addr, con: con, instr: "CALLA", vars: {c,z,<< 0b0::size(1) >>,d,<< 0b000::size(3) >>,<< 0b1::size(1) >>,<< 0b0::size(1) >>,<< 0b111::size(3) >>,<< 0b0::size(1) >>}, fullbin: <<fullbin::size(32)>>}), do: IO.inspect(all)

#                                           EEEE 1101011 CZ1 000000000 000101110        RETA                {WC/WZ/WCZ}
  def reta(all=%{addr: addr, con: con, instr: "RETA", vars: {c,z,<< 0b1::size(1) >>,<< 0b000000000000::size(12) >>,<< 0b1::size(1) >>,<< 0b0::size(1) >>,<< 0b111::size(3) >>,<< 0b0::size(1) >>}, fullbin: <<fullbin::size(32)>>}), do: IO.inspect(all)

#                                           EEEE 1101011 CZ0 DDDDDDDDD 000101111        CALLB   D           {WC/WZ/WCZ}
  def callb(all=%{addr: addr, con: con, instr: "CALLB", vars: {c,z,<< 0b0::size(1) >>,d,<< 0b000::size(3) >>,<< 0b1::size(1) >>,<< 0b0::size(1) >>,<< 0b1111::size(4) >>}, fullbin: <<fullbin::size(32)>>}), do: IO.inspect(all)

#                                           EEEE 1101011 CZ1 000000000 000101111        RETB                {WC/WZ/WCZ}
  def retb(all=%{addr: addr, con: con, instr: "RETB", vars: {c,z,<< 0b1::size(1) >>,<< 0b000000000000::size(12) >>,<< 0b1::size(1) >>,<< 0b0::size(1) >>,<< 0b1111::size(4) >>}, fullbin: <<fullbin::size(32)>>}), do: IO.inspect(all)

#                                           EEEE 1101011 00L DDDDDDDDD 000110000        JMPREL  D/#
  def jmprel(all=%{addr: addr, con: con, instr: "JMPREL", vars: {l,d,<< 0b000::size(3) >>,<< 0b11::size(2) >>,<< 0b0000::size(4) >>}, fullbin: <<fullbin::size(32)>>}), do: IO.inspect(all)

#                                           EEEE 1101011 00L DDDDDDDDD 000110001        SKIP    D/#
  def skip(all=%{addr: addr, con: con, instr: "SKIP", vars: {l,d,<< 0b000::size(3) >>,<< 0b11::size(2) >>,<< 0b000::size(3) >>,<< 0b1::size(1) >>}, fullbin: <<fullbin::size(32)>>}), do: IO.inspect(all)

#                                           EEEE 1101011 00L DDDDDDDDD 000110010        SKIPF   D/#
  def skipf(all=%{addr: addr, con: con, instr: "SKIPF", vars: {l,d,<< 0b000::size(3) >>,<< 0b11::size(2) >>,<< 0b00::size(2) >>,<< 0b1::size(1) >>,<< 0b0::size(1) >>}, fullbin: <<fullbin::size(32)>>}), do: IO.inspect(all)

#                                           EEEE 1101011 00L DDDDDDDDD 000110011        EXECF   D/#
  def execf(all=%{addr: addr, con: con, instr: "EXECF", vars: {l,d,<< 0b000::size(3) >>,<< 0b11::size(2) >>,<< 0b00::size(2) >>,<< 0b11::size(2) >>}, fullbin: <<fullbin::size(32)>>}), do: IO.inspect(all)

#                                           EEEE 1101011 000 DDDDDDDDD 000110100        GETPTR  D
  def getptr(all=%{addr: addr, con: con, instr: "GETPTR", vars: {d,<< 0b000::size(3) >>,<< 0b11::size(2) >>,<< 0b0::size(1) >>,<< 0b1::size(1) >>,<< 0b00::size(2) >>}, fullbin: <<fullbin::size(32)>>}), do: IO.inspect(all)

#                                           EEEE 1101011 CZ0 DDDDDDDDD 000110101        GETBRK  D           {WC/WZ/WCZ}
  def getbrk(all=%{addr: addr, con: con, instr: "GETBRK", vars: {c,z,<< 0b0::size(1) >>,d,<< 0b000::size(3) >>,<< 0b11::size(2) >>,<< 0b0::size(1) >>,<< 0b1::size(1) >>,<< 0b0::size(1) >>,<< 0b1::size(1) >>}, fullbin: <<fullbin::size(32)>>}), do: IO.inspect(all)

#                                           EEEE 1101011 00L DDDDDDDDD 000110101        COGBRK  D
  def cogbrk(all=%{addr: addr, con: con, instr: "COGBRK", vars: {l,d,<< 0b000::size(3) >>,<< 0b11::size(2) >>,<< 0b0::size(1) >>,<< 0b1::size(1) >>,<< 0b0::size(1) >>,<< 0b1::size(1) >>}, fullbin: <<fullbin::size(32)>>}), do: IO.inspect(all)

#                                           EEEE 1101011 00L DDDDDDDDD 000110110        BRK     D/#
  def brk(all=%{addr: addr, con: con, instr: "BRK", vars: {l,d,<< 0b000::size(3) >>,<< 0b11::size(2) >>,<< 0b0::size(1) >>,<< 0b11::size(2) >>,<< 0b0::size(1) >>}, fullbin: <<fullbin::size(32)>>}), do: IO.inspect(all)

#                                           EEEE 1101011 00L DDDDDDDDD 000110111        SETLUTS D/#
  def setluts(all=%{addr: addr, con: con, instr: "SETLUTS", vars: {l,d,<< 0b000::size(3) >>,<< 0b11::size(2) >>,<< 0b0::size(1) >>,<< 0b111::size(3) >>}, fullbin: <<fullbin::size(32)>>}), do: IO.inspect(all)

#                                           EEEE 1101011 00L DDDDDDDDD 000111000        SETCY   D/#
  def setcy(all=%{addr: addr, con: con, instr: "SETCY", vars: {l,d,<< 0b000::size(3) >>,<< 0b111::size(3) >>,<< 0b000::size(3) >>}, fullbin: <<fullbin::size(32)>>}), do: IO.inspect(all)

#                                           EEEE 1101011 00L DDDDDDDDD 000111001        SETCI   D/#
  def setci(all=%{addr: addr, con: con, instr: "SETCI", vars: {l,d,<< 0b000::size(3) >>,<< 0b111::size(3) >>,<< 0b00::size(2) >>,<< 0b1::size(1) >>}, fullbin: <<fullbin::size(32)>>}), do: IO.inspect(all)

#                                           EEEE 1101011 00L DDDDDDDDD 000111010        SETCQ   D/#
  def setcq(all=%{addr: addr, con: con, instr: "SETCQ", vars: {l,d,<< 0b000::size(3) >>,<< 0b111::size(3) >>,<< 0b0::size(1) >>,<< 0b1::size(1) >>,<< 0b0::size(1) >>}, fullbin: <<fullbin::size(32)>>}), do: IO.inspect(all)

#                                           EEEE 1101011 00L DDDDDDDDD 000111011        SETCFRQ D/#
  def setcfrq(all=%{addr: addr, con: con, instr: "SETCFRQ", vars: {l,d,<< 0b000::size(3) >>,<< 0b111::size(3) >>,<< 0b0::size(1) >>,<< 0b11::size(2) >>}, fullbin: <<fullbin::size(32)>>}), do: IO.inspect(all)

#                                           EEEE 1101011 00L DDDDDDDDD 000111100        SETCMOD D/#
  def setcmod(all=%{addr: addr, con: con, instr: "SETCMOD", vars: {l,d,<< 0b000::size(3) >>,<< 0b1111::size(4) >>,<< 0b00::size(2) >>}, fullbin: <<fullbin::size(32)>>}), do: IO.inspect(all)

#                                           EEEE 1101011 00L DDDDDDDDD 000111101        SETPIV  D/#
  def setpiv(all=%{addr: addr, con: con, instr: "SETPIV", vars: {l,d,<< 0b000::size(3) >>,<< 0b1111::size(4) >>,<< 0b0::size(1) >>,<< 0b1::size(1) >>}, fullbin: <<fullbin::size(32)>>}), do: IO.inspect(all)

#                                           EEEE 1101011 00L DDDDDDDDD 000111110        SETPIX  D/#
  def setpix(all=%{addr: addr, con: con, instr: "SETPIX", vars: {l,d,<< 0b000::size(3) >>,<< 0b11111::size(5) >>,<< 0b0::size(1) >>}, fullbin: <<fullbin::size(32)>>}), do: IO.inspect(all)

#                                           EEEE 1101011 00L DDDDDDDDD 000111111        COGATN  D/#
  def cogatn(all=%{addr: addr, con: con, instr: "COGATN", vars: {l,d,<< 0b000::size(3) >>,<< 0b111111::size(6) >>}, fullbin: <<fullbin::size(32)>>}), do: IO.inspect(all)

#                                           EEEE 1101011 CcL DDDDDDDDD 001000000        DIRL    D/#         {WCZ}
  def dirl(all=%{addr: addr, con: con, instr: "DIRL", vars: {c,c,l,d,<< 0b00::size(2) >>,<< 0b1::size(1) >>,<< 0b000000::size(6) >>}, fullbin: <<fullbin::size(32)>>}), do: IO.inspect(all)

#                                           EEEE 1101011 CZL DDDDDDDDD 001000000        TESTP   D/#         WC/WZ
  def testp(all=%{addr: addr, con: con, instr: "TESTP", vars: {c,z,l,d,<< 0b00::size(2) >>,<< 0b1::size(1) >>,<< 0b000000::size(6) >>}, fullbin: <<fullbin::size(32)>>}), do: IO.inspect(all)

#                                           EEEE 1101011 CcL DDDDDDDDD 001000001        DIRH    D/#         {WCZ}
  def dirh(all=%{addr: addr, con: con, instr: "DIRH", vars: {c,c,l,d,<< 0b00::size(2) >>,<< 0b1::size(1) >>,<< 0b00000::size(5) >>,<< 0b1::size(1) >>}, fullbin: <<fullbin::size(32)>>}), do: IO.inspect(all)

#                                           EEEE 1101011 CZL DDDDDDDDD 001000001        TESTPN  D/#         WC/WZ
  def testpn(all=%{addr: addr, con: con, instr: "TESTPN", vars: {c,z,l,d,<< 0b00::size(2) >>,<< 0b1::size(1) >>,<< 0b00000::size(5) >>,<< 0b1::size(1) >>}, fullbin: <<fullbin::size(32)>>}), do: IO.inspect(all)

#                                           EEEE 1101011 CcL DDDDDDDDD 001000010        DIRC    D/#         {WCZ}
  def dirc(all=%{addr: addr, con: con, instr: "DIRC", vars: {c,c,l,d,<< 0b00::size(2) >>,<< 0b1::size(1) >>,<< 0b0000::size(4) >>,<< 0b1::size(1) >>,<< 0b0::size(1) >>}, fullbin: <<fullbin::size(32)>>}), do: IO.inspect(all)

#                                           EEEE 1101011 CZL DDDDDDDDD 001000010        TESTP   D/#         ANDC/ANDZ
  def testp(all=%{addr: addr, con: con, instr: "TESTP", vars: {c,z,l,d,<< 0b00::size(2) >>,<< 0b1::size(1) >>,<< 0b0000::size(4) >>,<< 0b1::size(1) >>,<< 0b0::size(1) >>}, fullbin: <<fullbin::size(32)>>}), do: IO.inspect(all)

#                                           EEEE 1101011 CcL DDDDDDDDD 001000011        DIRNC   D/#         {WCZ}
  def dirnc(all=%{addr: addr, con: con, instr: "DIRNC", vars: {c,c,l,d,<< 0b00::size(2) >>,<< 0b1::size(1) >>,<< 0b0000::size(4) >>,<< 0b11::size(2) >>}, fullbin: <<fullbin::size(32)>>}), do: IO.inspect(all)

#                                           EEEE 1101011 CZL DDDDDDDDD 001000011        TESTPN  D/#         ANDC/ANDZ
  def testpn(all=%{addr: addr, con: con, instr: "TESTPN", vars: {c,z,l,d,<< 0b00::size(2) >>,<< 0b1::size(1) >>,<< 0b0000::size(4) >>,<< 0b11::size(2) >>}, fullbin: <<fullbin::size(32)>>}), do: IO.inspect(all)

#                                           EEEE 1101011 CcL DDDDDDDDD 001000100        DIRZ    D/#         {WCZ}
  def dirz(all=%{addr: addr, con: con, instr: "DIRZ", vars: {c,c,l,d,<< 0b00::size(2) >>,<< 0b1::size(1) >>,<< 0b000::size(3) >>,<< 0b1::size(1) >>,<< 0b00::size(2) >>}, fullbin: <<fullbin::size(32)>>}), do: IO.inspect(all)

#                                           EEEE 1101011 CZL DDDDDDDDD 001000100        TESTP   D/#         ORC/ORZ
  def testp(all=%{addr: addr, con: con, instr: "TESTP", vars: {c,z,l,d,<< 0b00::size(2) >>,<< 0b1::size(1) >>,<< 0b000::size(3) >>,<< 0b1::size(1) >>,<< 0b00::size(2) >>}, fullbin: <<fullbin::size(32)>>}), do: IO.inspect(all)

#                                           EEEE 1101011 CcL DDDDDDDDD 001000101        DIRNZ   D/#         {WCZ}
  def dirnz(all=%{addr: addr, con: con, instr: "DIRNZ", vars: {c,c,l,d,<< 0b00::size(2) >>,<< 0b1::size(1) >>,<< 0b000::size(3) >>,<< 0b1::size(1) >>,<< 0b0::size(1) >>,<< 0b1::size(1) >>}, fullbin: <<fullbin::size(32)>>}), do: IO.inspect(all)

#                                           EEEE 1101011 CZL DDDDDDDDD 001000101        TESTPN  D/#         ORC/ORZ
  def testpn(all=%{addr: addr, con: con, instr: "TESTPN", vars: {c,z,l,d,<< 0b00::size(2) >>,<< 0b1::size(1) >>,<< 0b000::size(3) >>,<< 0b1::size(1) >>,<< 0b0::size(1) >>,<< 0b1::size(1) >>}, fullbin: <<fullbin::size(32)>>}), do: IO.inspect(all)

#                                           EEEE 1101011 CcL DDDDDDDDD 001000110        DIRRND  D/#         {WCZ}
  def dirrnd(all=%{addr: addr, con: con, instr: "DIRRND", vars: {c,c,l,d,<< 0b00::size(2) >>,<< 0b1::size(1) >>,<< 0b000::size(3) >>,<< 0b11::size(2) >>,<< 0b0::size(1) >>}, fullbin: <<fullbin::size(32)>>}), do: IO.inspect(all)

#                                           EEEE 1101011 CZL DDDDDDDDD 001000110        TESTP   D/#         XORC/XORZ
  def testp(all=%{addr: addr, con: con, instr: "TESTP", vars: {c,z,l,d,<< 0b00::size(2) >>,<< 0b1::size(1) >>,<< 0b000::size(3) >>,<< 0b11::size(2) >>,<< 0b0::size(1) >>}, fullbin: <<fullbin::size(32)>>}), do: IO.inspect(all)

#                                           EEEE 1101011 CcL DDDDDDDDD 001000111        DIRNOT  D/#         {WCZ}
  def dirnot(all=%{addr: addr, con: con, instr: "DIRNOT", vars: {c,c,l,d,<< 0b00::size(2) >>,<< 0b1::size(1) >>,<< 0b000::size(3) >>,<< 0b111::size(3) >>}, fullbin: <<fullbin::size(32)>>}), do: IO.inspect(all)

#                                           EEEE 1101011 CZL DDDDDDDDD 001000111        TESTPN  D/#         XORC/XORZ
  def testpn(all=%{addr: addr, con: con, instr: "TESTPN", vars: {c,z,l,d,<< 0b00::size(2) >>,<< 0b1::size(1) >>,<< 0b000::size(3) >>,<< 0b111::size(3) >>}, fullbin: <<fullbin::size(32)>>}), do: IO.inspect(all)

#                                           EEEE 1101011 CZL DDDDDDDDD 001001000        OUTL    D/#         {WCZ}
  def outl(all=%{addr: addr, con: con, instr: "OUTL", vars: {c,z,l,d,<< 0b00::size(2) >>,<< 0b1::size(1) >>,<< 0b00::size(2) >>,<< 0b1::size(1) >>,<< 0b000::size(3) >>}, fullbin: <<fullbin::size(32)>>}), do: IO.inspect(all)

#                                           EEEE 1101011 CZL DDDDDDDDD 001001001        OUTH    D/#         {WCZ}
  def outh(all=%{addr: addr, con: con, instr: "OUTH", vars: {c,z,l,d,<< 0b00::size(2) >>,<< 0b1::size(1) >>,<< 0b00::size(2) >>,<< 0b1::size(1) >>,<< 0b00::size(2) >>,<< 0b1::size(1) >>}, fullbin: <<fullbin::size(32)>>}), do: IO.inspect(all)

#                                           EEEE 1101011 CZL DDDDDDDDD 001001010        OUTC    D/#         {WCZ}
  def outc(all=%{addr: addr, con: con, instr: "OUTC", vars: {c,z,l,d,<< 0b00::size(2) >>,<< 0b1::size(1) >>,<< 0b00::size(2) >>,<< 0b1::size(1) >>,<< 0b0::size(1) >>,<< 0b1::size(1) >>,<< 0b0::size(1) >>}, fullbin: <<fullbin::size(32)>>}), do: IO.inspect(all)

#                                           EEEE 1101011 CZL DDDDDDDDD 001001011        OUTNC   D/#         {WCZ}
  def outnc(all=%{addr: addr, con: con, instr: "OUTNC", vars: {c,z,l,d,<< 0b00::size(2) >>,<< 0b1::size(1) >>,<< 0b00::size(2) >>,<< 0b1::size(1) >>,<< 0b0::size(1) >>,<< 0b11::size(2) >>}, fullbin: <<fullbin::size(32)>>}), do: IO.inspect(all)

#                                           EEEE 1101011 CZL DDDDDDDDD 001001100        OUTZ    D/#         {WCZ}
  def outz(all=%{addr: addr, con: con, instr: "OUTZ", vars: {c,z,l,d,<< 0b00::size(2) >>,<< 0b1::size(1) >>,<< 0b00::size(2) >>,<< 0b11::size(2) >>,<< 0b00::size(2) >>}, fullbin: <<fullbin::size(32)>>}), do: IO.inspect(all)

#                                           EEEE 1101011 CZL DDDDDDDDD 001001101        OUTNZ   D/#         {WCZ}
  def outnz(all=%{addr: addr, con: con, instr: "OUTNZ", vars: {c,z,l,d,<< 0b00::size(2) >>,<< 0b1::size(1) >>,<< 0b00::size(2) >>,<< 0b11::size(2) >>,<< 0b0::size(1) >>,<< 0b1::size(1) >>}, fullbin: <<fullbin::size(32)>>}), do: IO.inspect(all)

#                                           EEEE 1101011 CZL DDDDDDDDD 001001110        OUTRND  D/#         {WCZ}
  def outrnd(all=%{addr: addr, con: con, instr: "OUTRND", vars: {c,z,l,d,<< 0b00::size(2) >>,<< 0b1::size(1) >>,<< 0b00::size(2) >>,<< 0b111::size(3) >>,<< 0b0::size(1) >>}, fullbin: <<fullbin::size(32)>>}), do: IO.inspect(all)

#                                           EEEE 1101011 CZL DDDDDDDDD 001001111        OUTNOT  D/#         {WCZ}
  def outnot(all=%{addr: addr, con: con, instr: "OUTNOT", vars: {c,z,l,d,<< 0b00::size(2) >>,<< 0b1::size(1) >>,<< 0b00::size(2) >>,<< 0b1111::size(4) >>}, fullbin: <<fullbin::size(32)>>}), do: IO.inspect(all)

#                                           EEEE 1101011 CZL DDDDDDDDD 001010000        FLTL    D/#         {WCZ}
  def fltl(all=%{addr: addr, con: con, instr: "FLTL", vars: {c,z,l,d,<< 0b00::size(2) >>,<< 0b1::size(1) >>,<< 0b0::size(1) >>,<< 0b1::size(1) >>,<< 0b0000::size(4) >>}, fullbin: <<fullbin::size(32)>>}), do: IO.inspect(all)

#                                           EEEE 1101011 CZL DDDDDDDDD 001010001        FLTH    D/#         {WCZ}
  def flth(all=%{addr: addr, con: con, instr: "FLTH", vars: {c,z,l,d,<< 0b00::size(2) >>,<< 0b1::size(1) >>,<< 0b0::size(1) >>,<< 0b1::size(1) >>,<< 0b000::size(3) >>,<< 0b1::size(1) >>}, fullbin: <<fullbin::size(32)>>}), do: IO.inspect(all)

#                                           EEEE 1101011 CZL DDDDDDDDD 001010010        FLTC    D/#         {WCZ}
  def fltc(all=%{addr: addr, con: con, instr: "FLTC", vars: {c,z,l,d,<< 0b00::size(2) >>,<< 0b1::size(1) >>,<< 0b0::size(1) >>,<< 0b1::size(1) >>,<< 0b00::size(2) >>,<< 0b1::size(1) >>,<< 0b0::size(1) >>}, fullbin: <<fullbin::size(32)>>}), do: IO.inspect(all)

#                                           EEEE 1101011 CZL DDDDDDDDD 001010011        FLTNC   D/#         {WCZ}
  def fltnc(all=%{addr: addr, con: con, instr: "FLTNC", vars: {c,z,l,d,<< 0b00::size(2) >>,<< 0b1::size(1) >>,<< 0b0::size(1) >>,<< 0b1::size(1) >>,<< 0b00::size(2) >>,<< 0b11::size(2) >>}, fullbin: <<fullbin::size(32)>>}), do: IO.inspect(all)

#                                           EEEE 1101011 CZL DDDDDDDDD 001010100        FLTZ    D/#         {WCZ}
  def fltz(all=%{addr: addr, con: con, instr: "FLTZ", vars: {c,z,l,d,<< 0b00::size(2) >>,<< 0b1::size(1) >>,<< 0b0::size(1) >>,<< 0b1::size(1) >>,<< 0b0::size(1) >>,<< 0b1::size(1) >>,<< 0b00::size(2) >>}, fullbin: <<fullbin::size(32)>>}), do: IO.inspect(all)

#                                           EEEE 1101011 CZL DDDDDDDDD 001010101        FLTNZ   D/#         {WCZ}
  def fltnz(all=%{addr: addr, con: con, instr: "FLTNZ", vars: {c,z,l,d,<< 0b00::size(2) >>,<< 0b1::size(1) >>,<< 0b0::size(1) >>,<< 0b1::size(1) >>,<< 0b0::size(1) >>,<< 0b1::size(1) >>,<< 0b0::size(1) >>,<< 0b1::size(1) >>}, fullbin: <<fullbin::size(32)>>}), do: IO.inspect(all)

#                                           EEEE 1101011 CZL DDDDDDDDD 001010110        FLTRND  D/#         {WCZ}
  def fltrnd(all=%{addr: addr, con: con, instr: "FLTRND", vars: {c,z,l,d,<< 0b00::size(2) >>,<< 0b1::size(1) >>,<< 0b0::size(1) >>,<< 0b1::size(1) >>,<< 0b0::size(1) >>,<< 0b11::size(2) >>,<< 0b0::size(1) >>}, fullbin: <<fullbin::size(32)>>}), do: IO.inspect(all)

#                                           EEEE 1101011 CZL DDDDDDDDD 001010111        FLTNOT  D/#         {WCZ}
  def fltnot(all=%{addr: addr, con: con, instr: "FLTNOT", vars: {c,z,l,d,<< 0b00::size(2) >>,<< 0b1::size(1) >>,<< 0b0::size(1) >>,<< 0b1::size(1) >>,<< 0b0::size(1) >>,<< 0b111::size(3) >>}, fullbin: <<fullbin::size(32)>>}), do: IO.inspect(all)
...
#                                           EEEE 1101011 CZL DDDDDDDDD 001011011        DRVNC   D/#         {WCZ}
  def drvnc(all=%{addr: addr, con: con, instr: "DRVNC", vars: {c,z,l,d,<< 0b00::size(2) >>,<< 0b1::size(1) >>,<< 0b0::size(1) >>,<< 0b11::size(2) >>,<< 0b0::size(1) >>,<< 0b11::size(2) >>}, fullbin: <<fullbin::size(32)>>}), do: IO.inspect(all)

#                                           EEEE 1101011 CZL DDDDDDDDD 001011100        DRVZ    D/#         {WCZ}
  def drvz(all=%{addr: addr, con: con, instr: "DRVZ", vars: {c,z,l,d,<< 0b00::size(2) >>,<< 0b1::size(1) >>,<< 0b0::size(1) >>,<< 0b111::size(3) >>,<< 0b00::size(2) >>}, fullbin: <<fullbin::size(32)>>}), do: IO.inspect(all)

#                                           EEEE 1101011 CZL DDDDDDDDD 001011101        DRVNZ   D/#         {WCZ}
  def drvnz(all=%{addr: addr, con: con, instr: "DRVNZ", vars: {c,z,l,d,<< 0b00::size(2) >>,<< 0b1::size(1) >>,<< 0b0::size(1) >>,<< 0b111::size(3) >>,<< 0b0::size(1) >>,<< 0b1::size(1) >>}, fullbin: <<fullbin::size(32)>>}), do: IO.inspect(all)

#                                           EEEE 1101011 CZL DDDDDDDDD 001011110        DRVRND  D/#         {WCZ}
  def drvrnd(all=%{addr: addr, con: con, instr: "DRVRND", vars: {c,z,l,d,<< 0b00::size(2) >>,<< 0b1::size(1) >>,<< 0b0::size(1) >>,<< 0b1111::size(4) >>,<< 0b0::size(1) >>}, fullbin: <<fullbin::size(32)>>}), do: IO.inspect(all)

#                                           EEEE 1101011 CZL DDDDDDDDD 001011111        DRVNOT  D/#         {WCZ}
  def drvnot(all=%{addr: addr, con: con, instr: "DRVNOT", vars: {c,z,l,d,<< 0b00::size(2) >>,<< 0b1::size(1) >>,<< 0b0::size(1) >>,<< 0b11111::size(5) >>}, fullbin: <<fullbin::size(32)>>}), do: IO.inspect(all)

#                                           EEEE 1101011 000 DDDDDDDDD 001100000        SPLITB  D
  def splitb(all=%{addr: addr, con: con, instr: "SPLITB", vars: {d,<< 0b00::size(2) >>,<< 0b11::size(2) >>,<< 0b00000::size(5) >>}, fullbin: <<fullbin::size(32)>>}), do: IO.inspect(all)

#                                           EEEE 1101011 000 DDDDDDDDD 001100001        MERGEB  D
  def mergeb(all=%{addr: addr, con: con, instr: "MERGEB", vars: {d,<< 0b00::size(2) >>,<< 0b11::size(2) >>,<< 0b0000::size(4) >>,<< 0b1::size(1) >>}, fullbin: <<fullbin::size(32)>>}), do: IO.inspect(all)

#                                           EEEE 1101011 000 DDDDDDDDD 001100010        SPLITW  D
  def splitw(all=%{addr: addr, con: con, instr: "SPLITW", vars: {d,<< 0b00::size(2) >>,<< 0b11::size(2) >>,<< 0b000::size(3) >>,<< 0b1::size(1) >>,<< 0b0::size(1) >>}, fullbin: <<fullbin::size(32)>>}), do: IO.inspect(all)

#                                           EEEE 1101011 000 DDDDDDDDD 001100011        MERGEW  D
  def mergew(all=%{addr: addr, con: con, instr: "MERGEW", vars: {d,<< 0b00::size(2) >>,<< 0b11::size(2) >>,<< 0b000::size(3) >>,<< 0b11::size(2) >>}, fullbin: <<fullbin::size(32)>>}), do: IO.inspect(all)

#                                           EEEE 1101011 000 DDDDDDDDD 001100100        SEUSSF  D
  def seussf(all=%{addr: addr, con: con, instr: "SEUSSF", vars: {d,<< 0b00::size(2) >>,<< 0b11::size(2) >>,<< 0b00::size(2) >>,<< 0b1::size(1) >>,<< 0b00::size(2) >>}, fullbin: <<fullbin::size(32)>>}), do: IO.inspect(all)

#                                           EEEE 1101011 000 DDDDDDDDD 001100101        SEUSSR  D
  def seussr(all=%{addr: addr, con: con, instr: "SEUSSR", vars: {d,<< 0b00::size(2) >>,<< 0b11::size(2) >>,<< 0b00::size(2) >>,<< 0b1::size(1) >>,<< 0b0::size(1) >>,<< 0b1::size(1) >>}, fullbin: <<fullbin::size(32)>>}), do: IO.inspect(all)

#                                           EEEE 1101011 000 DDDDDDDDD 001100110        RGBSQZ  D
  def rgbsqz(all=%{addr: addr, con: con, instr: "RGBSQZ", vars: {d,<< 0b00::size(2) >>,<< 0b11::size(2) >>,<< 0b00::size(2) >>,<< 0b11::size(2) >>,<< 0b0::size(1) >>}, fullbin: <<fullbin::size(32)>>}), do: IO.inspect(all)

#                                           EEEE 1101011 000 DDDDDDDDD 001100111        RGBEXP  D
  def rgbexp(all=%{addr: addr, con: con, instr: "RGBEXP", vars: {d,<< 0b00::size(2) >>,<< 0b11::size(2) >>,<< 0b00::size(2) >>,<< 0b111::size(3) >>}, fullbin: <<fullbin::size(32)>>}), do: IO.inspect(all)

#                                           EEEE 1101011 000 DDDDDDDDD 001101000        XORO32  D
  def xoro32(all=%{addr: addr, con: con, instr: "XORO32", vars: {d,<< 0b00::size(2) >>,<< 0b11::size(2) >>,<< 0b0::size(1) >>,<< 0b1::size(1) >>,<< 0b000::size(3) >>}, fullbin: <<fullbin::size(32)>>}), do: IO.inspect(all)

#                                           EEEE 1101011 000 DDDDDDDDD 001101001        REV     D
  def rev(all=%{addr: addr, con: con, instr: "REV", vars: {d,<< 0b00::size(2) >>,<< 0b11::size(2) >>,<< 0b0::size(1) >>,<< 0b1::size(1) >>,<< 0b00::size(2) >>,<< 0b1::size(1) >>}, fullbin: <<fullbin::size(32)>>}), do: IO.inspect(all)

#                                           EEEE 1101011 CZ0 DDDDDDDDD 001101010        RCZR    D           {WC/WZ/WCZ}
  def rczr(all=%{addr: addr, con: con, instr: "RCZR", vars: {c,z,<< 0b0::size(1) >>,d,<< 0b00::size(2) >>,<< 0b11::size(2) >>,<< 0b0::size(1) >>,<< 0b1::size(1) >>,<< 0b0::size(1) >>,<< 0b1::size(1) >>,<< 0b0::size(1) >>}, fullbin: <<fullbin::size(32)>>}), do: IO.inspect(all)

#                                           EEEE 1101011 CZ0 DDDDDDDDD 001101011        RCZL    D           {WC/WZ/WCZ}
  def rczl(all=%{addr: addr, con: con, instr: "RCZL", vars: {c,z,<< 0b0::size(1) >>,d,<< 0b00::size(2) >>,<< 0b11::size(2) >>,<< 0b0::size(1) >>,<< 0b1::size(1) >>,<< 0b0::size(1) >>,<< 0b11::size(2) >>}, fullbin: <<fullbin::size(32)>>}), do: IO.inspect(all)

#                                           EEEE 1101011 000 DDDDDDDDD 001101100        WRC     D
  def wrc(all=%{addr: addr, con: con, instr: "WRC", vars: {d,<< 0b00::size(2) >>,<< 0b11::size(2) >>,<< 0b0::size(1) >>,<< 0b11::size(2) >>,<< 0b00::size(2) >>}, fullbin: <<fullbin::size(32)>>}), do: IO.inspect(all)

#                                           EEEE 1101011 000 DDDDDDDDD 001101101        WRNC    D
  def wrnc(all=%{addr: addr, con: con, instr: "WRNC", vars: {d,<< 0b00::size(2) >>,<< 0b11::size(2) >>,<< 0b0::size(1) >>,<< 0b11::size(2) >>,<< 0b0::size(1) >>,<< 0b1::size(1) >>}, fullbin: <<fullbin::size(32)>>}), do: IO.inspect(all)

#                                           EEEE 1101011 000 DDDDDDDDD 001101110        WRZ     D
  def wrz(all=%{addr: addr, con: con, instr: "WRZ", vars: {d,<< 0b00::size(2) >>,<< 0b11::size(2) >>,<< 0b0::size(1) >>,<< 0b111::size(3) >>,<< 0b0::size(1) >>}, fullbin: <<fullbin::size(32)>>}), do: IO.inspect(all)

#                                           EEEE 1101011 000 DDDDDDDDD 001101111        WRNZ    D
  def wrnz(all=%{addr: addr, con: con, instr: "WRNZ", vars: {d,<< 0b00::size(2) >>,<< 0b11::size(2) >>,<< 0b0::size(1) >>,<< 0b1111::size(4) >>}, fullbin: <<fullbin::size(32)>>}), do: IO.inspect(all)
