...
## Drag this addr weirdness into a function at some point
  def disasm_instr(<<0b11011011::size(8), a::size(20)>>),
    do: "CALL #$+$#{:io_lib.format('~.16.0b', [(div(a,4)+1)])}"  ## double check that 1.  Looks like right locat but wondering if dirn is off ## **FIXME**
